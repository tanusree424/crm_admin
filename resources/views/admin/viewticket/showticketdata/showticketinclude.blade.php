                            ...
                            <div class="card-body status">
                                ...
                                <div class="form-group">
                                    <div class="custom-controls-stacked d-md-flex" id="text">
                                        ...
                                        <span class="custom-control-label">{{lang('Hold')}}</span>
                                        </label>
                                        <label class="custom-control form-radio success me-4">
                                        <input type="radio" class="custom-control-input hold sprukostatuschange" name="status" id="suspend" value="Suspend" @if(old('status') == 'Suspend') checked @endif {{ $ticket->status == 'Suspend' ? 'checked' : '' }}>
                                        <span class="custom-control-label">{{lang('Cancel')}}</span>
                                        </label>
                                    </div>
