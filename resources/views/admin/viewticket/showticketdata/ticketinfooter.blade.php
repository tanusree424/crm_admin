			...
			<table class="table mb-0 table-information">
				<tbody>
					...
					<tr>
						...
						<tr>
																	<td>
																		<span class="w-50">{{lang('Transfer Date')}}</span>
																	</td>
																	<td>:</td>
																	<td>
																		<span class="font-weight-semibold">{{ $ticket->transfer_date }}</span>
																	</td>
																</tr>
																...
																<tr>
																	<td>
																		<span class="w-50">{{lang('AWB No')}}</span>
																	</td>
																	<td>:</td>
																	<td>
																		<span class="font-weight-semibold">{{ $ticket->awb_no }}</span>
																	</td>
																</tr>
					...
					@if($customfield->fieldtypes != 'textarea')
						...
						@else
							...
							<tr>
								...
								<td>
									{{$customfield->values}} 
									@if (($customfield->fieldnames == 'Inward AWB' || $customfield->fieldnames == 'Delivery AWB') && $ticket->status != 'Closed' && $ticket->status != 'Suspend')
										<a href="javascript:void(0)" data-id="{{$ticket->id}}" data-fieldname="{{$customfield->fieldnames}}" data-fieldvalues="{{$customfield->values}}" class="p-1 editAWBOption border border-primary br-7 text-white bg-primary ms-2"> <i class="feather feather-edit-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"></i></a>
									@endif	
								</td>
							</tr>
