...
@section('content')
    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h4 class="page-title"><span class="font-weight-normal text-muted ms-2">{{ lang('Create Ticket', 'menu') }}</span>
            </h4>
        </div>
    </div>
    <!--End Page header-->
            ...
            <form method="post" id="admin_form" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            <label class="form-label mb-0 mt-2">{{ lang('First Name') }} <span class="text-red">*</span></label>
                            <input type="first_name" class="form-control @error('first_name') is-invalid @enderror"
                                placeholder="{{ lang('First Name') }}" value="{{ old('first_name') }}" name="first_name"
                                id="first_name">
                            @error('first_name')
                        ...
                        <div class="form-group col-md-3">
                            <label class="form-label mb-0 mt-2">{{ lang('Last Name') }} <span class="text-red">*</span></label>
                            <input type="last_name" class="form-control @error('last_name') is-invalid @enderror"
                                placeholder="{{ lang('Last Name') }}" value="{{ old('last_name') }}" name="last_name"
                                id="last_name">
                            @error('last_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ lang($message) }}</strong>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input required type="email" class="form-control @error('email') is-invalid @enderror"
                                placeholder="{{ lang('Email') }}" value="{{ old('email') }}" name="email" id="email">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ lang($message) }}</strong>
                                </span>
                    ...
                    <!-- Row 2: CC Email, Subject, Material -->
                    @if (setting('cc_email') == 'on')
                            <div class="form-group col-md-3">
                                <label class="form-label mb-0 mt-2">{{ lang('CC') }}</label>
                                <input type="email" class="form-control @error('ccmail') is-invalid @enderror"
                                    placeholder="{{ lang('CC Email') }}" value="{{ old('ccmail') }}" name="ccmail" id="ccmail">
                                @error('ccmail')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ lang($message) }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" id="subject" class="form-control @error('subject') is-invalid @enderror"
                                    maxlength="{{ setting('TICKET_CHARACTER') }}" placeholder="{{ lang('Subject') }}"
                                    name="subject" value="{{ old('subject') }}">
                                <small class="text-muted float-end mt-2" id="subjectmaxtext">
                                    {{ lang('Maximum') }} <b>{{ setting('TICKET_CHARACTER') }}</b> {{ lang('Characters') }}
                                </small>
                                @error('subject')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ lang($message) }}</strong>
                        ...
                        <div class="form-group col-md-3" id="selectssSubCategory" style="display: none;">
                            <label class="form-label mb-0 mt-2">{{ lang('Subcategory') }}</label>
                            <select class="form-control select2" data-placeholder="{{ lang('Select SubCategory') }}"
                                name="subscategory" id="subscategory"></select>
                        </div>
                       
                            <!-- <div class="form-group col-md-3">
                                    <label class="form-label mb-0 mt-2">{{ lang('Brand') }}<span class="text-red">*</span></label>
                                    <select class="form-control select2-show-search @error('brand') is-invalid @enderror"
                                        data-placeholder="{{ lang('Select brands') }}" name="brand" id="brand">
                                        <option label="{{ lang('Select brands') }}"></option>
                                ...
                                <div class="form-group col-md-3">
                                    <label class="form-label mb-0 mt-2">{{ lang('Product Type') }}<span class="text-red">*</span></label>
                                    <select class="form-control select2-show-search @error('product_type') is-invalid @enderror"
                                        data-placeholder="{{ lang('Select product_types') }}" name="product_type" id="product_type">
                                        <option label="{{ lang('Select product_types') }}"></option>
                            ...
                            <div class="form-group col-md-3">
                                <label class="form-label mb-0 mt-2">{{ lang('Materials') }}<span class="text-red">*</span></label>
                                <select class="form-control select2-show-search @error('material') is-invalid @enderror"
                                    data-placeholder="{{ lang('Select Materials') }}" name="material" id="material">
                                    <option label="{{ lang('Select Materials') }}"></option>
                                    @foreach ($materials as $material)
                                        <option value="{{ $material->id }}"
                                            @if (old('material') == $material['id']) selected @endif>{{ $material['material_code'] }} - {{ $material['material_name'] }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('material')
                    ...
                    @foreach ($customfields as $customfield)
                            ...
                            <div class="form-group col-md-3">
                                ...
                                @if ($customfield->fieldtypes == 'text')
                                    <input type="{{ $customfield->fieldtypes }}" maxlength="255" class="form-control"
                                        name="custom_{{ $customfield->id }}"
                                        {{ $customfield->fieldrequired == '1' ? 'required' : '' }}>
                                @elseif ($customfield->fieldtypes == 'email')
                                    <input type="{{ $customfield->fieldtypes }}" class="form-control"
                                        name="custom_{{ $customfield->id }}"
                                        {{ $customfield->fieldrequired == '1' ? 'required' : '' }}>
                                 @elseif ($customfield->fieldtypes == 'date')
                                    <input type="{{ $customfield->fieldtypes }}" class="form-control"
                                        name="custom_{{ $customfield->id }}"
                                        {{ $customfield->fieldrequired == '1' ? 'required' : '' }}>        
                                @elseif ($customfield->fieldtypes == 'textarea')
                                    <textarea name="custom_{{ $customfield->id }}" maxlength="255" class="form-control"
                                        cols="30" rows="4"
                                        {{ $customfield->fieldrequired == '1' ? 'required' : '' }}></textarea>
                                @elseif ($customfield->fieldtypes == 'checkbox')
                                    @php
                                    ...
                                    @endforeach
                                @elseif ($customfield->fieldtypes == 'select')
                                    <select name="custom_{{ $customfield->id }}" class="form-control select2-show-search"
                                ...
                                @elseif ($customfield->fieldtypes == 'radio')
                                    @php
                    ...
                    @endforeach
                    <div class="form-group col-md-3" id="selectSubCategory">
                            <!-- Subcategory or Custom Fields can go here -->
                        </div>
                    </div>
                @endif
                    <!-- Row 3: Category, Subcategory, Custom Fields -->
                        <!-- <div class="form-group col-md-3">
                            <label class="form-label mb-0 mt-2">{{ lang('Category') }}<span class="text-red">*</span></label>
                            <select class="form-control select2 @error('category') is-invalid @enderror"
                                data-placeholder="{{ lang('Select Category') }}" name="category" id="category">
                    ...
                    <!-- Row 4: Description and File Upload -->
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label class="form-label mb-0 mt-2">{{ lang('Description') }}<span class="text-red">*</span></label>
                            <textarea required class="form-control @error('message') is-invalid @enderror" rows="7"
                ...
                <div class="card-footer">
                    <div class="form-group float-end">
                        <button type="submit" id="createticketbtn" class="btn btn-secondary btn-lg purchasecode">
                            {{ lang('Create Ticket', 'menu') }}</button>
                    </div>
                </div>
            </form>
    ...
    <script>
document.querySelector('input[name="custom_3"]').addEventListener('blur', function() {
    var pinCode = this.value;

    if (pinCode.length === 6) { // Example length for pin codes, adjust as needed
        ...
        fetch(`https://api.postalpincode.in/pincode/${pinCode}`)
            ...
            .then(data => {
                    if (data[0].Status === "Success") {
                        ...
                        document.querySelector('input[name="custom_4"]').value = details.District;
                        document.querySelector('input[name="custom_25"]').value = details.State;
                        document.querySelector('input[name="custom_26"]').value = details.Country;
                        ...
                        document.querySelector('input[name="custom_4"]').value = '';
                        document.querySelector('input[name="custom_25"]').value = '';
                        document.querySelector('input[name="custom_26"]').value = '';
                    }
                })
                // if (data.success) {
                //     document.querySelector('input[name="custom_4"]').value = data.city;
                //     document.querySelector('input[name="custom_25"]').value = data.state;
                //     document.querySelector('input[name="custom_26"]').value = data.country;
                // } else {
                //     // Handle error or invalid pin code
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="userModalLabel">Previous Ticket info</h5>
    ...
    <script>
    document.querySelector('input[name="custom_23"]').addEventListener('input', function() {
        var pincode = this.value;

        // Example: Fetch address details from a hypothetical API
        // Replace the URL with your actual API endpoint
        fetch('https://api.example.com/address?pincode=' + pincode)
            .then(response => response.json())
            .then(data => {
                if (data) {
                    document.querySelector('input[name="custom_24"]').value = data.city || '';
                    document.querySelector('input[name="custom_25"]').value = data.state || '';
                    document.querySelector('input[name="custom_26"]').value = data.country || '';
                } else {
                    // Clear fields if no data found
                    document.querySelector('input[name="custom_24"]').value = '';
                    document.querySelector('input[name="custom_25"]').value = '';
                    document.querySelector('input[name="custom_26"]').value = '';
                }
            })
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#email').on('blur', function() {
                ...
                if (email) {
                    $.ajax({
                        url: '/admin/get-customer/adminlogin/' + email,
                        type: 'GET',
                        success: function(response) {
                            if (response.user_id) {
                                $('#user_id').val(response.user_id);
                                $('#EmailError').text('');
                                $('#modalMessage').text('Welcome back, existing user!');
                                // var link="<a class='btn btn-sm btn-outline-primary' href='/admin/customerprevioustickets/"+response.user_id+" target='_blank' rel='noopener noreferrer'>Previous Tickets</a>"
                                $('#modalMessage').append(
                                    "Click to check history : <a class='btn btn-sm btn-outline-primary' href='/admin/customerprevioustickets/" +
                                    response.user_id +
                                    "' target='_blank' rel='noopener noreferrer'>Previous Tickets</a>"
                                    );
                        ...
                        error: function(response) {
                            $('#user_id').val('');
                            $('#modalMessage').text('Hello, new user!');
                            $('#userModal').modal('show');
                        }
                    });
                }
...
@section('scripts')
    ...
    <script type="text/javascript">
                ...
                success: function(data) {
                    ...
                    if (data.subcategories.length >= 1) {
                        ...
                        $.each(data.subcategories, function(index, subcategory) {
                            $('#subcategory').append('<option value="' + subcategory.name +
                    ...
                    @if (setting('ENVATO_ON') == 'on')
                        ...
                        if (data.envatosuccess.length >= 1) {
                            ...
                            selectlabel.innerHTML =
                                "Envato Purchase Code <span class='text-red'>*</span>";
                            let divcol9 = document.createElement('div');
                            divcol9.setAttribute('class', 'col-md-10');
        ...
        $(window).on('load', function() {
            if (localStorage.getItem('adminsubject') || localStorage.getItem('adminmessage') || localStorage
                .getItem('adminemail')) {
                ...
                document.querySelector('.summernote').innerHTML = localStorage.getItem('adminmessage')?localStorage.getItem('adminmessage'):'';
                document.querySelector('.note-editable').innerHTML = localStorage.getItem('adminmessage')?localStorage.getItem('adminmessage'):'';
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    if (data.message == 'createticket') {
                        ...
                        if (localStorage.getItem('adminsubject') || localStorage.getItem('adminmessage') ||
