												...
												<tbody>
													...
													<tr {{$tickets->replystatus == 'Replied'? 'class=bg-success-transparent': ''}}>
														...
														<td>
															...
															<a href="{{url('admin/ticket-view/' . $tickets->id)}}">{{$tickets->ticket_id}}</a> <span class="badge badge-danger-light">{{$tickets->overduestatus}}</span>
															@else
															<a href="{{url('admin/ticket-view/' . $tickets->id)}}">{{$tickets->ticket_id}}</a> <span class="badge badge-danger-light">{{$tickets->overduestatus}}</span> <span class="badge badge-warning-light">{{lang('Note')}}</span>
															@endif
														</td>
														<td>
