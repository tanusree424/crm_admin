...
class MaterialGroup3Controller extends Controller
{
    public function index()
    {

        $materialgroup1code = MaterialGroup3::latest()->get();
        ...
        return view('admin.materialgroup3.index',compact('basic','title','footertext'))->with($data)->with('i', (request()->input('page', 1) - 1) * 5);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            $project = MaterialGroup3::updateOrCreate(['id' => $testiId], $testi);
    ...
    public function destroy($id)
    {
      ...
      $testimonial = MaterialGroup3::find($id);
      $testimonial->delete();
    ...
    public function materialmassdestroy(Request $request){
        ...
        $projects = MaterialGroup3::whereIn('id', $student_id_array)->get();
    ...
    public function projectassignee(Request $r)
    {
        ...
        $projects = MaterialGroup3::find($r->projected);
        if(!empty($projects)){
        foreach ($projects as $project){
    ...
    public function projetimport(){
        ...
        return view('admin.materialgroup3.projectimport')->with($data);
    }
